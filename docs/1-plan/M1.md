...
| T0' | ModelConfig dataclass | ⬜ | [M1-T0p-ModelConfig.md](../2-tasks/M1-T0p-ModelConfig.md) | 20m |
| **T1** | **RMSNorm** | **✅** | [M1-T1-RMSNorm.md](../2-tasks/M1-T1-RMSNorm.md) | 已完成 |
| T2 | SwiGLU MLP | ⬜ | [M1-T2-SwiGLU.md](../2-tasks/M1-T2-SwiGLU.md) | 1h |
| T3 | RoPE | ⬜ | 开工时创建 | 2h |
