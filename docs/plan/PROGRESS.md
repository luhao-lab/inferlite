...
| **M4** PagedAttention (PyTorch) | 🟡 | — | — | — | 排期由一周顺延为两周（W1+W2，至 2026-08-02）。T1 BlockPool 已完成（`7d51e25`）；T2~T7 待完成：BlockTable / PagedKVCache / PyTorch gather 伪版 / Engine / Benchmark / Docs |
