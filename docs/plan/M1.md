...
QwenLM/Qwen3、llama.cpp、SGLang、TGI、TensorRT-LLM 统一记录在 `docs/kb/REFERENCES.md`；M1 只按上表读取，不泛读。
...
| # | 名称 | 状态 | 前置 | [P] | 任务卡详情 | 估时 |
| --- | --- | --- | --- | --- | --- | --- |
| **T0** | **ModelConfig dataclass** | **✅** | — | — | [M1-T0-ModelConfig.md](../tasks/M1-T0-ModelConfig.md) | 已完成 |
| **T1** | **RMSNorm** | **✅** | T0 | ✓ | [M1-T1-RMSNorm.md](../tasks/M1-T1-RMSNorm.md) | 已完成 |
| **T2** | **SwiGLU MLP** | **✅** | T0 | ✓ | [M1-T2-SwiGLU.md](../tasks/M1-T2-SwiGLU.md) | 已完成 |
| T3 | RoPE | ✅ | T0 | ✓ | [M1-T3-RoPE.md](../tasks/M1-T3-RoPE.md) | 已完成 |
| T4 | GQA Attention | ✅ | T1, T3 | — | [M1-T4-GQA-Attention.md](../tasks/M1-T4-GQA-Attention.md) | 已完成 |
| T5 | DecoderLayer | ✅ | T1, T2, T4 | — | [M1-T5-DecoderLayer.md](../tasks/M1-T5-DecoderLayer.md) | 已完成 |
| T6 | Qwen3Model | ✅ | T1, T5 | — | [M1-T6-Qwen3Model.md](../tasks/M1-T6-Qwen3Model.md) | 已完成 |
| T7 | WeightMap + load_from_hf | ✅ | T6 | — | [M1-T7-WeightMap-load-from-hf.md](../tasks/M1-T7-WeightMap-load-from-hf.md) | 已完成 |
| **T8** | **L1 logits 对齐** | ✅ | T7 | — | [M1-T8-L1-logits-alignment.md](../tasks/M1-T8-L1-logits-alignment.md) | 已完成 |
...
| # | 名称 | 状态 | 前置 | [P] | 任务卡详情 | 估时 |
| --- | --- | --- | --- | --- | --- | --- |
| T9 | LLMModel Protocol + GreedySampler | ✅ | T8 | — | [M1-T9-LLMModel-GreedySampler.md](../tasks/M1-T9-LLMModel-GreedySampler.md) | 已完成 |
| T10 | EngineCore.step() 三段式 | ✅ | T9 | — | [M1-T10-EngineCore-step.md](../tasks/M1-T10-EngineCore-step.md) | 已完成 |
| T11 | CLI + L2 e2e | ✅ | T10 | — | [M1-T11-CLI-L2-e2e.md](../tasks/M1-T11-CLI-L2-e2e.md) | 已完成 |
| T12-pre | Last-token logits optimization | ✅ | T11 | — | [M1-T12-pre-last-token-logits.md](../tasks/M1-T12-pre-last-token-logits.md) | 已完成 |
| T12 | Real Qwen3-0.6B smoke test | ✅ | T12-pre | — | [M1-T12-smoke-test.md](../tasks/M1-T12-smoke-test.md) | 已完成 |
...
> 见 [docs/kb/REFERENCES.md](../kb/REFERENCES.md) — 三梯队开源项目（nano-vllm / LLMs-from-scratch / transformers / vllm / ...）+ 论文清单 + 阶段-资料对照表。
